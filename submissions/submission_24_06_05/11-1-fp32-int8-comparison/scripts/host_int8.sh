# produces a network which expects 32,224,224,3 input data (see model/resnet18_int8.cpp)
...
${QNN_SDK_ROOT}/bin/x86_64-linux-clang/qnn-net-run \
              ...
              --model model_libs/x86_64-linux-clang/libresnet18_int8.so \
              --input_list target_raw_list_host.txt \
              --output_dir=output/host_int8